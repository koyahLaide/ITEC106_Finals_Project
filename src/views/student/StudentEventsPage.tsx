...
import { Calendar, MapPin, Users, Search, UserPlus, QrCode, CheckCircle, GraduationCap } from 'lucide-react'
...
export function StudentEventsPage() {
  ...
  useEffect(() => {
    ...
    if (savedEmail) setRegisterEmail(savedEmail)
    if (savedName) setRegisterName(savedName)
  }, [])
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        localStorage.setItem('studentName', registerName)
    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-emerald-700 to-emerald-800 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-emerald-200">Discover and register for events at CvSU — no account needed!</p>
        </div>
      </section>
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <Label htmlFor="s-reg-name">Full Name</Label>
                    <Input
                      id="s-reg-name"
                  ...
                  <div>
                    <Label htmlFor="s-reg-email">Email Address</Label>
                    <Input
                      id="s-reg-email"
                      type="email"
